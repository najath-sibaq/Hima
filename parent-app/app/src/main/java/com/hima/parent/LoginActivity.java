...
public class LoginActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				id.edit().putString("id", edittext1.getText().toString()).commit();
	...
	private void initializeLogic() {
		linear3.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)15, 0xFF383E7E));
		...
		textview2.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/semi.ttf"), 0);
	}
